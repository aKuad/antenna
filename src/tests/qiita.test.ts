  ...
  await t.step(async function qiita_true() {
    ...
    const posts_expected: FetchResult = {
      posts: [{
        ...
        description: "## きっかけ [個人開発](https://github.com/aKuad/web-dmx)にて、[PlatformIO](https://platformio.org/)[^pio] でマイコンボード [NUCLEO-F303K8](https://www.st.com/en/evaluation-tools/nucleo-f303k8.html) のプログラムを開発していたとき･･･ [^",
        thumbnail_url: "",
      ...
      },
      {
        ...
        author_url: "https://qiita.com/aKuad",
        author_icon_url: "https://avatars2.githubusercontent.com/u/53811809?v=4",
        description: "## ある日 [あるリポジトリ](https://github.com/aKuad/docs-gen-samples)を久々に更新して、そのついでにワークフローで使用している Action のバージョンアップをしていました。 ```diff_yaml     steps:       - name: Source checkout -       uses: actions/checkout@v4",
        thumbnail_url: "",
      ...
      },
      {
        ...
        author_url: "https://qiita.com/aKuad",
        author_icon_url: "https://avatars2.githubusercontent.com/u/53811809?v=4",
        description: "## 取り扱っているのは こちら、Doxygen などソースコードドキュメントジェネレータのサンプル集てきなものを作っています。 https://github.com/aKuad/docs-gen-samples リポジトリ内のソースから[ドキュメントを自動ビルドして](https://github.com/aKuad/docs-gen-samples/blob/main/.github/work",
        thumbnail_url: "",
      ...
      },
      {
        ...
        author_url: "https://qiita.com/aKuad",
        author_icon_url: "https://avatars2.githubusercontent.com/u/53811809?v=4",
        description: "## GitHub リポジトリの 'Deployments' って？ これのことです。 ![GitHub Repositoy - Deployments](https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/540894/b6bf4b50-29af-4b68-be1a-18a27fb7d633.png) :::note warn ",
        thumbnail_url: "",
