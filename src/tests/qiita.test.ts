  ...
  await t.step(async function qiita_true() {
    ...
    const posts_expected: FetchResult = {
      ...
      },
      {
        ...
        author_url: "https://qiita.com/aKuad",
        author_icon_url: "https://avatars2.githubusercontent.com/u/53811809?v=4",
        description: "## ある日  [あるリポジトリ](https://github.com/aKuad/docs-gen-samples)を久々に更新して、そのついでにワークフローで使用している Action のバージョンアップをしていました。  ```diff_yaml     steps:       - name: Source checkout -       uses: actions/checkout@",
        thumbnail_url: "",
      ...
      },
      {
        ...
        author_url: "https://qiita.com/aKuad",
        author_icon_url: "https://avatars2.githubusercontent.com/u/53811809?v=4",
        description: "## 取り扱っているのは  こちら、Doxygen などソースコードドキュメントジェネレータのサンプル集てきなものを作っています。  https://github.com/aKuad/docs-gen-samples  リポジトリ内のソースから[ドキュメントを自動ビルドして](https://github.com/aKuad/docs-gen-samples/blob/main/.github/w",
        thumbnail_url: "",
